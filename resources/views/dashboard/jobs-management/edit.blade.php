                ...
                <div class="grid grid-cols-1 gap-4 sm:grid-cols-2 sm:gap-6 w-full">
                    <div class="">
                        ...
                        <input type="text" name="job_title" id="title" 
                            ...
                            @enderror"
                            placeholder="Enter title" autofocus value="{{ old('job_title', $job->job_title) }}">
                    ...
                    <div class="">
                        ...
                        <input type="text" name="job_department" id="department" 
                            ...
                            @error('job_department') 
                                ...
                                dark:bg-gray-700 dark:text-red-500 dark:placeholder-red-500 dark:border-red-500 
                            @enderror"
                            placeholder="Enter department" value="{{ old('job_department', $job->job_department) }}">
                    ...
                    <div class="">
                        ...
                        @enderror">
                            ...
                            @if (old('job_work_type', $job->job_work_type)==='Remote') selected 
                            @endif>Remote</option>
                            <option value="Onsite" @if (old('job_work_type', $job->job_work_type)==='Onsite') selected 
                            @endif>Onsite</option>
                        </select>
                        @error('job_work_type')
                        <p class="mt-1 text-sm text-red-600 dark:text-red-500">{{ $message }}</p>
                    ...
                    <div>
                        ...
                        @enderror">
                            ...
                            @if (old('job_status', $job->job_status)==='Open') selected 
                            @endif>Open</option>
                            <option value="Closed" @if (old('job_status', $job->job_status)==='Closed') selected 
                            @endif>Closed</option>
                    ...
                    <div>
                        ...
                        bg-red-50 border-red-500 text-red-900 placeholder-red-700 focus:ring-red-500 focus:border-red-500
                        dark:bg-gray-700 dark:text-red-500 dark:placeholder-red-500 dark:border-red-500 
                        @enderror" placeholder="Enter total positions" value="{{ old('job_total_positions', $job->job_total_positions) }}">
                        @error('job_total_positions')
                        <p class="mt-1 text-sm text-red-600 dark:text-red-500">{{ $message }}</p>
                        @enderror
                    </div>
                    ...
                    <div class="sm:col-span-2">
                        ...
                        >{{ old('job_requirements', $job->job_requirements) }}</textarea>
                    ...
                    <div class="sm:col-span-2">
                        ...
                        <input type="hidden" id="description" name="job_description" value="{{ old('job_description', $job->job_description) }}">
                    ...
                    <div class="sm:col-span-2">
                        ...
                        <input type="hidden" name="oldImage" value="{{ $job->job_image }}">
                        @if($job->job_image)
                        <img src="{{ asset('storage/'.$job->job_image) }}" class="img-preview w-full h-auto max-w-xs rounded-lg mb-2" alt="">
                        @else
                        @endif
