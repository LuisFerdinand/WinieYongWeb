...
<div class="container mx-auto mt-2">
    ...
    <section class="bg-white dark:bg-gray-900 rounded-2xl items-start">
        <div class="py-8 px-4 max-w-2xl">
            ...
            <form action="{{ route('projects-management.update', $project->project_slug) }}" method="POST" enctype="multipart/form-data">
                @method('PUT')
                @csrf
                <div class="grid grid-cols-1 gap-4 sm:grid-cols-2 sm:gap-6 w-full">
                    <div class="">
                        ...
                        <input type="text" name="project_name" id="name" 
                            ...
                            @enderror"
                            placeholder="Enter name" autofocus value="{{ old('project_name', $project->project_name) }}">
                    ...
                    <div class="sm:col-span-2">
                        <div class="grid gap-2 sm:grid-cols-3 sm:gap-3">
                            <div class="w-full">
                                ...
                                bg-red-50 border-red-500 text-red-900 placeholder-red-700 focus:ring-red-500 focus:border-red-500
                                dark:bg-gray-700 dark:text-red-500 dark:placeholder-red-500 dark:border-red-500 
                                @enderror" placeholder="Enter date" value="{{ old('project_date', $project->project_date ? \Carbon\Carbon::parse($project->project_date)->format('Y-m-d') : '') }}">
                                <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">
                                    <span class="text-info-500 inline-flex items-center">
                            ...
                            <div class="w-full">
                                ...
                                <input type="text" name="project_client" id="client" class="bg-gray-50 border text-gray-900 text-sm rounded-lg block w-full p-2.5 dark:bg-gray-700 dark:text-white focus:ring-primary-600 focus:border-primary-600
                                    @error('project_client') 
                                        ...
                                        dark:bg-gray-700 dark:text-red-500 dark:placeholder-red-500 dark:border-red-500 
                                    @enderror"
                                    placeholder="Enter client" autofocus value="{{ old('project_client', $project->project_client) }}">
                            ...
                            <div class="w-full">
                                ...
                                dark:bg-gray-700 dark:text-red-500 dark:placeholder-red-500 dark:border-red-500 
                                @enderror">
                                    <option value="Ongoing" {{ old('project_status', $project->project_status) == 'Ongoing' ? 'selected' : '' }} selected>
                                        Ongoing
                                    </option>
                                    <option value="Completed" {{ old('project_status', $project->project_status) == 'Completed' ? 'selected' : '' }}>
                                        Completed
                                    </option>
                                    <option value="On Hold" {{ old('project_status', $project->project_status) == 'On Hold' ? 'selected' : '' }}>
                                        On Hold
                                    </option>
                                    <option value="Cancelled" {{ old('project_status', $project->project_status) == 'Cancelled' ? 'selected' : '' }}>
                                        Cancelled
                                    </option>
                                    <option value="Planned" {{ old('project_status', $project->project_status) == 'Planned' ? 'selected' : '' }}>
                                        Planned
                                    </option>
                                </select>
                                @error('project_status')
                    ...
                    <div class="sm:col-span-2">
                        ...
                        <input type="hidden" id="description" name="project_description" value="{{ old('project_description', $project->project_description) }}">
                    ...
                    <div class="sm:col-span-2">
                        ...
                        <input type="hidden" id="highlights" name="project_highlights" value="{{ old('project_highlights', $project->project_highlights) }}">
                    ...
                    <div class="sm:col-span-2">
                        ...
                        <input type="hidden" name="oldImage" value="{{ $project->project_image }}">
                        @if($project->project_image)
                        <img src="{{ asset('storage/'.$project->project_image) }}" class="img-preview w-full h-auto max-w-xs rounded-lg mb-2" alt="">
                        @else
                        @endif
