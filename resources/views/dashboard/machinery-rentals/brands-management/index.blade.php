                    ...
                    <form action="{{ route('brands-management.index') }}" method="GET">
                        <div class="flex items-center w-full mx-auto mb-0 sm:max-w-screen-sm space-x-2 overflow-hidden">
                            ...
                            <div class="flex-shrink-0">
                                <a href="{{ route('brands-management.index') }}" class="bg-gray-300 text-black px-4 py-2 rounded-lg">Reset</a>
                            </div>
                        </div>
                    </form>
                </div>
            ...
            <tbody>
                ...
                <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
                    ...
                    <th class="flex items-center pr-6 pl-2 py-4 text-gray-900 dark:text-white">
                        ...
                        <img class="w-14 h-14 object-contain rounded border-gray-500 border md:w-16 md:h-16" src="{{ asset('storage/'.$rental->brand_image) }}" alt="">
                        @elseif($rental->brand_image_url)
                        <img class="w-14 h-14 object-contain rounded border-gray-500 border md:w-16 md:h-16" src="{{ $rental->brand_image_url }}" alt="">
                        @else
                        ...
                        <div class="ps-3 w-44">
                            <span class=" 
                                bg-{{ $rental->brand_color }}-100 text-{{ $rental->brand_color }}-600 text-md font-medium inline-flex items-center px-2 py-0.5 rounded dark:bg-rental-200 dark:text-rental-800">
                    ...
                    <td class="border-x px-2 py-4">
                        <div class="flex items-center justify-center gap-2">
                            <a href="{{ route('brands-management.show', $rental->brand_slug) }}"
                            ...
                            <a href="{{ route('brands-management.edit', $rental->brand_slug) }}" class="text-yellow-500 font-bold">
                            ...
                            <form action="{{ route('brands-management.destroy', $rental->brand_slug) }}" method="POST" class="inline-block">
                                @csrf
                                @method('DELETE')
