...
<div class="container mx-auto mt-2">
    ...
    <section class="bg-white dark:bg-gray-900 rounded-2xl items-start">
        <div class="py-8 px-4 max-w-2xl">
            ...
            <form action="{{ route('categories-management.store') }}" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="grid grid-cols-1 gap-4 sm:grid-cols-2 sm:gap-6 w-full">
                    <div class="">
                        ...
                        <input type="text" name="category_name" id="name" 
                            ...
                            @enderror"
                            placeholder="Enter name" autofocus value="{{ old('category_name') }}">
                    ...
                    <div>
                        ...
                        <input type="text" id="slug" name="category_slug" aria-label="disabled input 2" class="bg-gray-100 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 cursor-not-allowed dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-gray-400 dark:focus:ring-blue-500 dark:focus:border-blue-500" value="{{ old('category_slug') }}" readonly>
                        
                    </div>
                    <div class="sm:col-span-2">
                        <label for="description" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Description</label>
                        <input type="hidden" id="description" name="category_description" value="{{ old('category_description') }}">
