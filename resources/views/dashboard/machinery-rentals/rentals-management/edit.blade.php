...
<div class="container mx-auto mt-2">
    ...
    <section class="bg-white dark:bg-gray-900 rounded-2xl items-start">
        <div class="py-8 px-4 max-w-2xl">
            ...
            <form action="{{ route('rentals-management.update', $rental->type_slug) }}" method="POST" enctype="multipart/form-data">
                @method('PUT')
                @csrf
                <div class="grid grid-cols-1 gap-4 sm:grid-cols-2 sm:gap-6 w-full">
                    <div class="">
                        ...
                        <input type="text" name="type_name" id="name" 
                            ...
                            @enderror"
                            placeholder="Enter name" autofocus value="{{ old('type_name', $rental->type_name) }}">
                        ...
                        <div class="grid gap-2 sm:grid-cols-3 sm:gap-3">
                            <div class="w-full">
                                ...
                                bg-red-50 border-red-500 text-red-900 placeholder-red-700 focus:ring-red-500 focus:border-red-500 dark:bg-gray-700 dark:text-red-500 dark:placeholder-red-500 dark:border-red-500 @enderror">
                                    @foreach ($categories as $category)
                                        @if (old('category_id', $rental->category_id)==$category->category_id)
                            ...
                            <div class="w-full">
                                ...
                                @enderror">
                                    ...
                                    @if (old('brand_id', $rental->brand_id)==$brand->brand_id)
                            ...
                            <div class="w-full">
                                ...
                                @enderror">
                                    ...
                                    @if (old('type_availability', $rental->type_availability)==='1') selected 
                                    @endif>Available</option>
                                    <option value="0" @if (old('type_availability', $rental->type_availability)==='0') selected 
                    ...
                    <div class="sm:col-span-2">
                        <div class="grid gap-2 sm:grid-cols-3 sm:gap-3">
                            <div class="w-full">
                                ...
                                bg-red-50 border-red-500 text-red-900 placeholder-red-700 focus:ring-red-500 focus:border-red-500
                                dark:bg-gray-700 dark:text-red-500 dark:placeholder-red-500 dark:border-red-500 
                                @enderror" placeholder="Enter length" value="{{ old('type_length', $rental->type_length) }}">
                                @error('type_length')
                                <p class="mt-1 text-sm text-red-600 dark:text-red-500">{{ $message }}</p>
                                @enderror
                            </div>
                            <div class="w-full">
                                ...
                                bg-red-50 border-red-500 text-red-900 placeholder-red-700 focus:ring-red-500 focus:border-red-500
                                dark:bg-gray-700 dark:text-red-500 dark:placeholder-red-500 dark:border-red-500 
                                @enderror" placeholder="Enter width" value="{{ old('type_width', $rental->type_width) }}">
                                @error('type_width')
                                <p class="mt-1 text-sm text-red-600 dark:text-red-500">{{ $message }}</p>
                                @enderror
                            </div>
                            <div class="w-full">
                                ...
                                bg-red-50 border-red-500 text-red-900 placeholder-red-700 focus:ring-red-500 focus:border-red-500
                                dark:bg-gray-700 dark:text-red-500 dark:placeholder-red-500 dark:border-red-500 
                                @enderror" placeholder="Enter height" value="{{ old('type_height', $rental->type_height) }}">
                                @error('type_height')
                                <p class="mt-1 text-sm text-red-600 dark:text-red-500">{{ $message }}</p>
                                @enderror
                            </div>
                    ...
                    <div>
                        ...
                        bg-red-50 border-red-500 text-red-900 placeholder-red-700 focus:ring-red-500 focus:border-red-500
                        dark:bg-gray-700 dark:text-red-500 dark:placeholder-red-500 dark:border-red-500 
                        @enderror" placeholder="Enter operating weight" value="{{ old('type_operating_weight', $rental->type_operating_weight) }}">
                        @error('type_operating_weight')
                        <p class="mt-1 text-sm text-red-600 dark:text-red-500">{{ $message }}</p>
                        @enderror
                    </div> 
                    <div>
                        ...
                        bg-red-50 border-red-500 text-red-900 placeholder-red-700 focus:ring-red-500 focus:border-red-500
                        dark:bg-gray-700 dark:text-red-500 dark:placeholder-red-500 dark:border-red-500 
                        @enderror" placeholder="Enter engine power" value="{{ old('type_engine_power', $rental->type_engine_power) }}">
                        @error('type_engine_power')
                        <p class="mt-1 text-sm text-red-600 dark:text-red-500">{{ $message }}</p>
                        @enderror
                    </div> 
                    <div>
                        ...
                        bg-red-50 border-red-500 text-red-900 placeholder-red-700 focus:ring-red-500 focus:border-red-500
                        dark:bg-gray-700 dark:text-red-500 dark:placeholder-red-500 dark:border-red-500 
                        @enderror" placeholder="Enter fuel capacity" value="{{ old('type_fuel_capacity', $rental->type_fuel_capacity) }}">
                        @error('type_fuel_capacity')
                        <p class="mt-1 text-sm text-red-600 dark:text-red-500">{{ $message }}</p>
                        @enderror
                    </div> 
                    <div>
                        ...
                        bg-red-50 border-red-500 text-red-900 placeholder-red-700 focus:ring-red-500 focus:border-red-500
                        dark:bg-gray-700 dark:text-red-500 dark:placeholder-red-500 dark:border-red-500 
                        @enderror" placeholder="Enter max speed" value="{{ old('type_max_speed', $rental->type_max_speed) }}">
                        @error('type_max_speed')
                        <p class="mt-1 text-sm text-red-600 dark:text-red-500">{{ $message }}</p>
                        @enderror
                    </div> 
                    <div class="sm:col-span-2">
                        ...
                        <input type="hidden" id="description" name="type_description" value="{{ old('type_description', $rental->type_description) }}">
                    ...
                    <div class="sm:col-span-2">
                        ...
                        <input type="hidden" name="oldImage" value="{{ $rental->type_image }}">
                        @if($rental->type_image)
                        <img src="{{ asset('storage/'.$rental->type_image) }}" class="img-preview w-full h-auto max-w-xs d-block rounded-lg" alt="">
                        @else
                        @endif
