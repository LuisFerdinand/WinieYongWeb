...
<div class="container mx-auto mt-2">
    ...
    <section class="bg-white dark:bg-gray-900 rounded-2xl items-start">
        <div class="py-8 px-4 max-w-2xl">
            ...
            <form action="{{ route('products-management.update', $product->product_slug) }}" method="POST" enctype="multipart/form-data">
                @method('PUT')
                @csrf
                <div class="grid grid-cols-1 gap-4 sm:grid-cols-2 sm:gap-6 w-full">
                    <div class="">
                        ...
                        <input type="text" name="product_name" id="name" 
                            ...
                            @enderror"
                            placeholder="Enter name" autofocus value="{{ old('product_name', $product->product_name) }}">
                    ...
                    <div class="">
                        ...
                        <input type="text" name="product_model_number" id="model_number" 
                            ...
                            @error('product_model_number') 
                                ...
                                dark:bg-gray-700 dark:text-red-500 dark:placeholder-red-500 dark:border-red-500 
                            @enderror"
                            placeholder="Enter model number" autofocus value="{{ old('product_model_number', $product->product_model_number) }}">
                    ...
                    <div class="w-full">
                        ...
                        <div class="flex-grow relative flex">
                            ...
                            bg-red-50 border-red-500 text-red-900 placeholder-red-700 focus:ring-red-500 focus:border-red-500
                            dark:bg-gray-700 dark:text-red-500 dark:placeholder-red-500 dark:border-red-500 
                            @enderror" placeholder="Enter price" type="number" id="price" name="product_price" value="{{ old('product_price', $product->product_price) }}">
                    ...
                    <div class="sm:col-span-2">
                        <div class="grid gap-2 sm:grid-cols-3 sm:gap-3">
                            <div class="w-full">
                                ...
                                bg-red-50 border-red-500 text-red-900 placeholder-red-700 focus:ring-red-500 focus:border-red-500
                                dark:bg-gray-700 dark:text-red-500 dark:placeholder-red-500 dark:border-red-500 
                                @enderror" placeholder="Enter power_output" value="{{ old('product_power_output', $product->product_power_output) }}">
                                @error('product_power_output')
                                <p class="mt-1 text-sm text-red-600 dark:text-red-500">{{ $message }}</p>
                                @enderror
                            </div>
                            <div class="w-full">
                                ...
                                <input type="text" name="product_dimensions" id="dimensions" 
                                    ...
                                    @error('product_dimensions') 
                                        ...
                                        dark:bg-gray-700 dark:text-red-500 dark:placeholder-red-500 dark:border-red-500 
                                    @enderror"
                                    placeholder="Enter model number" autofocus value="{{ old('product_dimensions', $product->product_dimensions) }}">
                            ...
                            <div class="w-full">
                                ...
                                <input type="text" name="product_fuel_type" id="fuel_type" 
                                    ...
                                    @error('product_fuel_type') 
                                        ...
                                        dark:bg-gray-700 dark:text-red-500 dark:placeholder-red-500 dark:border-red-500 
                                    @enderror"
                                    placeholder="Enter fuel type" autofocus value="{{ old('product_fuel_type', $product->product_fuel_type) }}">
                    ...
                    <div class="sm:col-span-2">
                        ...
                        >{{ old('product_usage_instructions', $product->product_usage_instructions) }}</textarea>
                    ...
                    <div class="sm:col-span-2">
                        ...
                        <input type="hidden" id="description" name="product_description" value="{{ old('product_description', $product->product_description) }}">
                    ...
                    <div class="sm:col-span-2">
                        ...
                        <img src="{{ asset('storage/'.$product->product_image) }}" class="img-preview w-full h-auto max-w-xs rounded-lg mb-2" alt="">
                        @else
                        @endif
