...
<div class="container mx-auto mt-2">
    ...
    <section class="bg-white dark:bg-gray-900 rounded-2xl items-start">
        <div class="py-8 px-4 max-w-2xl">
            ...
            <form action="{{ route('parts-management.store') }}" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="grid grid-cols-1 gap-4 sm:grid-cols-2 sm:gap-6 w-full">
                    <div class="">
                        ...
                        <input type="text" name="part_name" id="name" 
                            ...
                            @enderror"
                            placeholder="Enter name" autofocus value="{{ old('part_name') }}">
                    ...
                    <div class="">
                        ...
                        <input type="text" name="part_category" id="category" 
                            ...
                            @error('part_category') 
                                ...
                                dark:bg-gray-700 dark:text-red-500 dark:placeholder-red-500 dark:border-red-500 
                            @enderror"
                            placeholder="Enter category" autofocus value="{{ old('part_category') }}">
                    ...
                    <div class="w-full">
                        ...
                        <div class="flex-grow relative flex">
                            ...
                            bg-red-50 border-red-500 text-red-900 placeholder-red-700 focus:ring-red-500 focus:border-red-500
                            dark:bg-gray-700 dark:text-red-500 dark:placeholder-red-500 dark:border-red-500 
                            @enderror" placeholder="Enter price" type="number" id="price" name="part_price" value="{{ old('part_price') }}">
                    ...
                    <div class="">
                        ...
                        <input type="text" name="part_contact" id="contact" 
                            ...
                            @error('part_contact') 
                                ...
                                dark:bg-gray-700 dark:text-red-500 dark:placeholder-red-500 dark:border-red-500 
                            @enderror"
                            placeholder="Enter contact" autofocus value="{{ old('part_contact') }}">
                    ...
                    <div class="">
                        ...
                        <input type="text" name="part_location" id="location" 
                            ...
                            @error('part_location') 
                                ...
                                dark:bg-gray-700 dark:text-red-500 dark:placeholder-red-500 dark:border-red-500 
                            @enderror"
                            placeholder="Enter location" autofocus value="{{ old('part_location') }}">
                    ...
                    <div class="sm:col-span-2">
                        ...
                        <input type="hidden" id="description" name="part_description" value="{{ old('part_description') }}">
