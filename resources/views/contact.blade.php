...
<section class="min-h-screen md:mt-10 py-32 lg:py-20 flex items-center justify-center">
    <div class="max-w-[1440px] mx-auto px-4 sm:px-6 lg:px-8">
        <div class="bg-white rounded-2xl shadow-xl overflow-hidden">
            <div class="lg:flex">
                <!-- Contact Information -->
                <div class="lg:w-1/2 bg-teal-600 text-white p-12 lg:p-16 flex flex-col justify-between">
                    <div>
                    ...
                    <div class="mt-12">
                        ...
                        <div class="flex space-x-4">
                            ...
                            <a href="#" class="text-white hover:text-teal-200" target="blank">
                ...
                <!-- Contact Form -->
                <div class="lg:w-1/2 p-12 lg:p-16">
                    <p class="text-teal-600 tracking-widest font-bold mb-0">|<span> Message Form</span></p>
