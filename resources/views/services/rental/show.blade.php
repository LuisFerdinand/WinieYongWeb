          ...
          <div class="lg:grid lg:grid-cols-2 lg:gap-8 xl:gap-16">
            <div class="shrink-0 max-w-md lg:max-w-lg mx-auto">
              <<<<<<< HEAD
                ...
                <img class="w-full dark:hidden rounded-md object-cover" src={{ $rental->type_image }} alt="" />
            ...
            <div class="mb-0 flex items-end  justify-between  gap-4">
              ...
              <div>
                ...
                <div class="flex items-center justify-center gap-1 text-slate-400 font-medium">
                  <a href="{{ route('rentals.trackClick', $rental->slug) }}" target="_blank" class="inline-flex items-center rounded-lg bg-green-500 px-5 py-2.5 text-sm font-medium text-white hover:bg-green-600 focus:outline-none focus:ring-4 focus:ring-primary-300 dark:bg-primary-600 dark:hover:bg-primary-700 dark:focus:ring-primary-800">
                    <svg class="w-6 h-6 text-white dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
