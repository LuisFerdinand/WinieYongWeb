        ...
        <div class="max-w-screen-xl px-4 mx-auto 2xl:px-0">
          <div class="lg:grid lg:grid-cols-2 lg:gap-8 xl:gap-16">
            <div class="shrink-0 max-w-md lg:max-w-lg mx-auto">
              <div class=" w-full shadow-lg rounded-md border-2 overflow-hidden ">
                ...
                @else
                <img class="mx-auto h-full dark:hidden rounded-md object-cover" src="{{ asset('img/NoImg.png') }}" alt="" />
                @endif
